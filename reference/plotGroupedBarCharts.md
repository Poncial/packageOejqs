...
mais accepte toute liste de `data.table` contenant au minimum une
colonne de groupe, une colonne de statistique centrale (`mean` ou
`median`) et une colonne d'erreur (`se`, `sd`, `ci` ou `iqr`).
