...
|----|----|
| Une seule question, répartition des réponses | [`plotPercentBar()`](../reference/plotPercentBar.md) |
| Une question, comparaison entre groupes | [`plotGroupedBarCharts()`](../reference/plotGroupedBarCharts.md) |
| Plusieurs questions binaires (Oui/Non) | [`plotMultiBinBar()`](../reference/plotMultiBinBar.md) |
| Scores moyens, plusieurs items x groupes | [`plotProportionHeatmap()`](../reference/plotProportionHeatmap.md) |
...
> 💡 **Astuce :** utilise
> [`recodeBinary()`](../reference/recodeBinary.md) au préalable pour
> préparer tes données si elles sont encore sous forme textuelle
> (Oui/Non).
