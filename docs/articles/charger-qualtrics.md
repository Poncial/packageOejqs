...
> 💡 **Note :** [`extractLabels()`](../reference/extractLabels.md)
...
Utilise [`cleanTextCols()`](../reference/cleanTextCols.md) après le
chargement pour normaliser les espaces, la ponctuation et les caractères
spéciaux :
